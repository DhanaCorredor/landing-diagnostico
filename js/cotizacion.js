  ...
  back.innerHTML =
    '<div class="qsheet" role="dialog" aria-modal="true" aria-label="Tu cotización">' +
      ...
      '<div class="qsheet-foot">' +
        '<div class="qsheet-total"><span>Total estimado</span><b class="qsheet-sum">$0</b></div>' +
        '<p class="qsheet-note">Precios referenciales · el monto final lo confirma el centro.</p>' +
